...
//                    joinQRs.add(subQr);
//                    subQr = tmpQr;
//                    subQr.setJoinChildrens(joinQRs);
...
//                    unionQRs.add(subQr);
//                    subQr = tmpQr;
//                    subQr.setUnionChildrens(unionQRs);

                }

            }
//            else if( ast.getToken().getType()==HiveParser.TOK_JOIN||ast.getToken().getType()==HiveParser.TOK_FULLOUTERJOIN||ast.getToken().getType()==HiveParser.TOK_RIGHTOUTERJOIN||ast.getToken().getType()==HiveParser.TOK_LEFTOUTERJOIN){
//                if(subQr.getJoinChildrens()==null){
